...
CREATE TABLE `origin_country` (
  ...
  KEY `fk_ORIGIN_COUNTRY_ORIGIN_CONTINENT1_idx` (`ORIGIN_CONTINENT_ContinentID`),
  CONSTRAINT `fk_ORIGIN_COUNTRY_ORIGIN_CONTINENT1` FOREIGN KEY (`ORIGIN_CONTINENT_ContinentID`) REFERENCES `origin_continent` (`ContinentID`)
...
INSERT INTO `origin_country` VALUES (1,'France',2),(2,'Italy',2),(3,'Finland',2),(4,'Singapore',1),(5,'United States',4),(6,'Republic of Korea',1),(7,'Germany',2);
