...
CREATE TABLE `retrieval` (
  ...
  KEY `fk_RETRIEVAL_INSTITUTE1_idx` (`INSTITUTE_InstituteID`),
  KEY `fk_RETRIEVAL_SEED1_idx` (`SEED_SeedID`),
  CONSTRAINT `fk_RETRIEVAL_INSTITUTE1` FOREIGN KEY (`INSTITUTE_InstituteID`) REFERENCES `institute` (`InstituteID`),
  CONSTRAINT `fk_RETRIEVAL_SEED1` FOREIGN KEY (`SEED_SeedID`) REFERENCES `seed` (`SeedID`)
